...
public class SemisterRegistrationDaoImpl implements SemisterRegistrationDaoInterface {
	...
	/*
	 * @Override public void setRegistrationStatus(int studentId) throws
	 * SQLException { Connection conn = DBUtils.getConnection(); try { stmt =
	 * conn.prepareStatement(SQLConstants.SET_REGISTRATION_STATUS); stmt.setInt(1,
	 * studentId); stmt.executeUpdate();
	 * 
	 * } catch (SQLException e) { } finally { stmt.close(); conn.close(); }
	 * 
	 * }
	 */
