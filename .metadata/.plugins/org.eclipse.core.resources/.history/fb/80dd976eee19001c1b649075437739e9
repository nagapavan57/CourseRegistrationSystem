...
public class ProfessorDaoImpl implements ProfessorDaoInterface{
	...
	public List<Course> getCoursesByProfessor(String profId) {
		...
		try{
			...
			while(res.next()){
				courseList.add(
						new Course(res.getString("coursecode"), res.getString("coursename"), 
	...
	public List<StudentsEnrolled> getEnrolledStudents(String profId) {
		...
		try{
			...
			while(res.next()){
				studentList.add(
						new StudentsEnrolled(res.getString("coursecode"), res.getString("coursename"), res.getInt("studentid")));
			}
